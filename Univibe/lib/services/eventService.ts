...
const processOrganizerProfilePicture = (event: Event): Event => {
  ...
  if (event.organizer && event.organizer.profilePicture) {
    event.organizer.profilePicture = getFullImageUrl(
...
export const eventService = {
  ...
  addEventImages: async (
    ...
    try {
      ...
      const response = await enhancedFetch(
        `${BASE_URL}/api/events/${eventId}/images`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  removeEventImage: async (
    ...
    try {
      ...
      const response = await enhancedFetch(
        `${BASE_URL}/api/events/${eventId}/images/${imageIndex}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  toggleInterest: async (
    ...
    try {
      ...
      const response = await enhancedFetch(
        `${BASE_URL}/api/events/${eventId}/interested`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
