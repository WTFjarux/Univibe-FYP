...
const menuItems = [
  ...
  { path: "/communities", icon: Building2, label: "Communities" },
    ...
    >
        ...
        {isOpen && (
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              style={{ fontFamily: "Sofia, serif", color: "#111827" }}
            >
              UNIVIBE
            </span>
          </div>
      ...
      <nav className="flex-1 py-4 px-3">
        {menuItems.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-3 rounded-xl mb-1 transition-all duration-200 ${isActive ? "" : "hover:bg-gray-50"}`
            }
            style={({ isActive }) => ({
      ...
      <div className="p-3 border-t" style={{ borderColor: "#f3f4f6" }}>
        <button
          ...
          className="flex items-center gap-3 px-3 py-3 rounded-xl w-full hover:bg-red-50 transition-colors"
        >
          <LogOut
