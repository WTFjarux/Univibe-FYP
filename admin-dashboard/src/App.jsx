...
function Settings() {
  return (
    <div className="text-center py-20">
      ...
      <h1 style={{ fontFamily: 'Sofia Sans', fontWeight: 700, fontSize: 24, color: '#111827' }}>Settings</h1>
      <p className="text-gray-500 mt-2" style={{ fontFamily: 'Sofia Sans' }}>Configure admin preferences</p>
